/*! For license information please see 6817.1426ac0298c1c07d9591-site-bundle.js.LICENSE.txt */
(self.webpackChunkbobcat_monorepo = self.webpackChunkbobcat_monorepo || []).push([
    [6817], {
        636817: function(e, t, l) {
            e.exports = {
                internal: "s5-theme",
                sectionSelections: {
                    cta: {
                    ...
                    booking: {
                        ...
                        displayName: "Booking",
                        group: "product",
                        description: "Set your booking information, availability, and start taking appointments.",
                        position: 2,
                        content: l(721174)
                    },
                    columns: {
                    ...
                    custom_form: {
                        sectionId: "custom_form",
                        category: "content",
                        displayName: "Custom Form",
                        group: "form",
                        description: "Add a fully customizable form with any fields you want.",
                        position: 12,
                        content: l(517828)
                    },
                    donation: {
                    ...
                    faq: {
                        ...
                        group: "text",
                        description: "Show text content in an accordion format. Each item can be expanded to show the full text.",
                        position: 27,
                        content: l(843241)
                    },
                    featureListA: {
                        sectionId: "featureList",
                        category: "content",
                        displayName: "Feature List A",
                        group: "list",
                    ...
                    portfolio: {
                        ...
                        group: "product",
                        description: "An advanced business portfolio. Each product or item opens in its own page, where you can add a price, gallery, and detailed description.",
                        position: 3,
                        content: l(289221)
                    },
                    pricing: {
                        ...
                        group: "pricing",
                        description: "Show your plans, prices, and benefits in an elegant grid, with clear calls-to-action.",
                        position: 10,
                        content: l(244508)
                    },
                    process: {
