/*! For license information please see 1626.81342178201484e0344d-site-bundle.js.LICENSE.txt */
                        ...
                        return s(n, [{
                            ...
                            value: function(t) {
                                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                                    ...
                                    s = i > 0 && o ? i / o : 0;
                                return {
                                    deltaX: (this.content.fitWidth * t - n) * a,
                ...
                var D = {
                    ...
                    H = function(t) {
                        ...
                        return s(n, [{
                            ...
                            value: function() {
                                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                    e = g(this.getPageFromPosition(-1 * this.Panzoom.content.x), 2)[1];
                                this.slideTo(e, t)
                            }
                        }, {
                    ...
                    G = function() {
                        ...
                        return s(t, [{
                            ...
                            value: function(t) {
                                ...
                                if (n.className = "fancybox__iframe", n.setAttribute("id", "fancybox__iframe_".concat(i.id, "_").concat(t.index)), n.setAttribute("allow", "autoplay; fullscreen"), n.setAttribute("scrolling", "auto"), t.$iframe = n, "iframe" !== t.type || !1 === t.preload) return n.setAttribute("src", t.src), n.setAttribute("scrolling", "no"), this.fancybox.setContent(t, n), void this.resizeIframe(t);
                                i.showLoading(t);
                        ...
                        return s(i, [{
                            ...
                            value: function(t) {
                                if (!t.defaultPrevented) {
                                    ...
                                    if (e.matches(X) || document.activeElement.blur(), !e.closest(".fancybox__content") && !getSelection().toString().length && !1 !== this.trigger("click", t)) switch (this.option("click")) {
                                        case "close":
                                            this.close();
                                            break;
                                        case "next":
                            ...
                            value: function(t) {
                                if (i.getInstance().id === this.id) {
                                    ...
                                    if (n && !t.ctrlKey && !t.altKey && !t.shiftKey) {
                                        ...
                                        if ("Escape" !== e && !s && (t.target.isContentEditable || -1 !== ["BUTTON", "TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].indexOf(o.nodeName))) return;
                            ...
                            key: "show",
                            value: function(t) {
                                return new i(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {})
                            }
                        }, {
                            key: "fromEvent",
                            value: function(t) {
                            ...
                            value: function() {
                                ...
                                if (arguments.length > 0 && void 0 !== arguments[0] && !arguments[0]) {
                                    ...
                                    var o, a = x(at.values());
                                    try {
                                        for (a.s(); !(o = a.n()).done;) o.value.close(e)
                                    } catch (t) {
                                        a.e(t)
                                    } finally {
                                        a.f()
