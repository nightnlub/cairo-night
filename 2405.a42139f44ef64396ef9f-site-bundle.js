/*! For license information please see 2405.a42139f44ef64396ef9f-site-bundle.js.LICENSE.txt */
        ...
        72405: function(e, n, t) {
            ...
            var r = t(501068),
                ...
                C = function(e) {
                    ...
                    }, void 0, x.createElement(D.Z, (0, N.Z)({}, n, {
                ...
                R = function(e) {
                    ...
                    return (0, i.Z)("div", {
                    ...
                    }, void 0, x.createElement(D.Z, (0, N.Z)({}, r, {
                        type: "textarea",
                        showCount: !0,
                        placeholder: a,
                        maxLength: o || 500
                        ...
                        className: "count"
                    }, void 0, Z()(n = "".concat((null === (t = r.value) || void 0 === t ? void 0 : t.length) || 0, " / ")).call(n, o)), s && l && (0, i.Z)("div", {
                        className: "form-field-error"
                    }, void 0, l))
                },
                O = t(294184),
                ...
                T = t(117847),
                _ = t(975538),
                q = P("stores.pageMeta.id") || P("blogPostData.pageMeta.id"),
                M = t(353147),
                j = function(e) {
                    var n = e.score,
                        t = e.meta,
                    ...
                    }, void 0, M("Ecommerce|Rate this product")), (0, i.Z)("div", {
                ...
                X = t.n(Q),
                $ = function() {
                    var e = (0, U.Z)(X().mark((function e(n) {
                        var t;
            ...
            function ee() {
                return (ee = (0, U.Z)(X().mark((function e(n) {
                    var t, r, o;
                    return X().wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.prev = 0, e.next = 3, (0, z.fetchJSON)(Z()(t = "/r/v1/sites/".concat(q, "/ecommerce/product_reviews/")).call(t, n, "/order_info"), {
                                    method: "GET"
                                });
                            case 3:
                            ...
                            case 10:
                                return e.prev = 10, e.t0 = e.catch(0), e.next = 14, $(e.t0);
                            case 14:
                                throw e.sent;
                            case 15:
                            case "end":
            ...
            function ne() {
                return (ne = (0, U.Z)(X().mark((function e(n) {
                    var t, r;
                    return X().wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.prev = 0, e.next = 3, (0, z.fetchJSON)("/r/v1/sites/".concat(q, "/ecommerce/product_reviews"), {
                                    method: "POST",
                                    body: K()(n)
                                });
                            case 3:
            ...
            var te, re, oe, ie = t(576574),
                ae = (t(588034), t(353147));
            var ce = function(e) {
                    (0, l.Z)(m, e);
                    ...
                    function m(e) {
                        ...
                        return (0, a.Z)(this, m), n = r.call(this, e), (0, p.Z)((0, s.Z)(n), "onFetchProductDetail", (function(e) {
                            (function(e) {
                                ...
                                }))) : alert(ae("Ecommerce|Sorry, this product is currently unavailable for review. Please contact us if you have any questions."))
                            }))
                            ...
                            v()(e).call(e, "invalid content") > -1 ? alert(ae("Ecommerce|Sorry, the comment may contain illegal content. Please check and modify it and submit it again.")) : v()(e).call(e, "already submit review") > -1 ? (n.onCloseDialog(), n.setState({
                                errorType: "repeatSubmit"
                            }, (function() {
                                return n.onOpenReviewFailureDialog()
                            ...
                            return I.getGDPRComplianceFeature()
                            ...
                            e && e((function(e) {
                                if (!i || r) {
                                    ...
                                    gdprError: ae("Dashboard|You must agree to the terms and conditions to continue.")
                                })
                            }))()
                    ...
                    return (0, c.Z)(m, [{
                        ...
                        value: function() {
                            var e = this.state,
                                ...
                                b = void 0 === f ? [] : f;
                            return (0, i.Z)("div", {}, void 0, (0, i.Z)(J.Z, {
                                ...
                                }, void 0, e.name ? Z()(t = "".concat(e.name, ": ")).call(t, e.value) : e.value), n >= 0 && n < b.length - 1 && (re || (re = (0, i.Z)("span", {
                                    className: "line"
                                }))))
                            }))), (0, i.Z)(V.Z, {
                                className: "product-reviews-form"
                            }, void 0, (0, i.Z)(ie.Field, {
                                name: "score",
                                score: u,
                                draftScore: r,
                                component: j,
                                ...
                                name: "name",
                                component: C,
                                placeholder: ae("Ecommerce|Your name")
                            }), (0, i.Z)(ie.Field, {
                                name: "content",
                                maxLength: 500,
                                component: R,
                                placeholder: ae("Ecommerce|Leave any comments…")
                            ...
                            }, void 0, ae("Ecommerce|Submit Review"))), (0, i.Z)(J.Z, {
                            ...
                            }, void 0, oe || (oe = (0, i.Z)(Y.Z, {
                                type: "fa fa-check success-icon"
                            })), (0, i.Z)("div", {
                                className: "review-title"
                            }, void 0, ae("Ecommerce|Review submitted!")), (0, i.Z)("div", {
                                className: "review-text"
                            }, void 0, ae("Ecommerce|Thank you for your review!")), (0, i.Z)(B.Z, {
                                className: "back-btn no-margin",
                                onClick: this.handleCloseReviewSuccessDialog
                            }, void 0, ae("Ecommerce|Back to site")))), (0, i.Z)(J.Z, {
                                ...
                                src: (0, H.cdnAssetPath)(T.U.WARNING_MESSAGE_ICON)
                            }), (0, i.Z)("div", {
                                className: "error-message"
                            }, void 0, ae("repeatSubmit" === o ? "Ecommerce|You have already submitted a review for this product." : "Ecommerce|Sorry, product reviews cannot be submitted at this time. Please contact us if you have any questions.")))))
                        }
                    }]), m
                }(x.Component),
                se = (0, ie.formValueSelector)("productReviewsForm"),
                le = (0, k.connect)((function(e) {
                    var n = y.fromJS({
                        name: "",
                        score: 0,
                        content: ""
                    ...
                    validate: function(e) {
                        var n = {},
                            ...
                            o = t.score,
                            i = t.content;
                        return o || (n.score = ae("Ecommerce|Rate this product")), r || (n.name = ae("Ecommerce|Name is required")), i || (n.content = ae("Ecommerce|Comment is required")), n
                    },
